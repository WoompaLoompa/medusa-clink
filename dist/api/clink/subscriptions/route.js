...
const subscription_1 = require("../../../modules/clink/subscription");
/**
...
function getSubscriptionService() {
    return new subscription_1.SubscriptionService({ logger: console }, DEFAULT_OPTIONS);
}
/**
...
async function POST(req, res) {
    try {
        ...
        const { customer_id, amount_sats, currency_code, interval, debit_pointer, max_payments, metadata } = req.body;
