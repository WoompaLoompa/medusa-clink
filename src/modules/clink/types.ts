...
export const CLINK_DEFAULTS: Partial<ClinkOptions> = {
...
export function isClinkError(response: ClinkOfferResponse): response is ClinkOfferResponseError {
