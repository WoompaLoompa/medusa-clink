...
import {
  storePaymentSession,
  PaymentSession
} from "../../../../modules/clink/store"
import type { ClinkOptions } from "../../../../modules/clink/types"
...
export async function POST(
  ...
  try {
    const { cart_id, amount, currency_code } = req.body as PaymentSessionRequest
    ...
    const currencyService = new CurrencyService(options)
